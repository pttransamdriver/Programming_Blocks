...
if rider2 == "Y":
    ...
    if age2 < 12:
        print("Your second rider is too young for this ride. Sorry")
    elif age2 >= 12 and age2 <= 17 and height2 >= 36:
...
if height1 >= 36:
    if age1 >= 18:
        print("Have fun riding the ride!")
    elif age1 < 12:
        print("Sorry, not today young one")
    elif age1 <= 17 and golden_pass1 != "Y" and golden_pass2 != "Y":
        print("Sorry, you don't meet the requirments for this ride :(")
    elif golden_pass1 == "Y" and rider2 != "Y":
        print ("Have fun on the ride! ")

else:
    print("Sorry, rider(s) do(es) not meet the ride qualifications :(")